...
class RoutesDelegator
{
    public function __invoke(ContainerInterface $container, string $serviceName, callable $callback): Application
    {
        ...
        $app->put('/process/{idprocess:\d+}', [AuthorizationMiddleware::class,PutProcessMiddleware::class,PutProcessHandler::class], 'process.put');
        $app->post('/process', [AuthorizationMiddleware::class,PostProcessMiddleware::class,PostProcessHandler::class], 'process.post');

        $app->get('/process/{idprocess:\d+}/movements/last', [AuthorizationMiddleware::class,GetLastMoveProcessHandler::class], 'process.movements.last.get');
        $app->get('/process/movements', [AuthorizationMiddleware::class,GetProcessMovementMiddleware::class,GetProcessMovementHandler::class], 'process.movements.get');
        $app->post('/process/movements', [AuthorizationMiddleware::class,PostProcessMovementMiddleware::class,PostProcessMovementHandler::class], 'process.movements.post');
